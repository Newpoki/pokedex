...
const bugTypeHandler = () => {
  return rest.get(`https://pokeapi.co/api/v2/type/bug`, (req, res, ctx) => {
    return res(ctx.json(mockedBugTypeData));
  });
};

export const mockedBugType = {
  data: mockedBugTypeData,
  handler: bugTypeHandler,
};
