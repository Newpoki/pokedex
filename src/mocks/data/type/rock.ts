...
const rockTypeHandler = () => {
  return rest.get(`https://pokeapi.co/api/v2/type/rock`, (req, res, ctx) => {
    return res(ctx.json(mockedRockTypeData));
  });
};

export const mockedRockType = {
  data: mockedRockTypeData,
  handler: rockTypeHandler,
};
