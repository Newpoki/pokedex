...
const mockedGhostTypeData: Type = {
  damage_relations: {
    double_damage_from: [
      {
        name: "ghost",
...
const ghostTypeHandler = () => {
  return rest.get(`https://pokeapi.co/api/v2/type/ghost`, (req, res, ctx) => {
    return res(ctx.json(mockedGhostTypeData));
  });
};

export const mockedGhostType = {
  data: mockedGhostTypeData,
