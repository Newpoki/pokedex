...
const mockedDefaultPokemonsData: PokemonList = {
  count: 1126,
...
const defaultPokemonsHandler = () => {
  return rest.get("https://pokeapi.co/api/v2/pokemon", (req, res, ctx) => {
    return res(ctx.json(mockedDefaultPokemonsData));
  });
};

const defaultInfiniteQueryHookData = {
  pageParams: [undefined],
  pages: [mockedDefaultPokemonsData],
};

export const mockedDefaultPokemons = {
  data: mockedDefaultPokemonsData,
  handler: defaultPokemonsHandler,
