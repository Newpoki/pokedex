...
import { PokemonSpecies } from "../../../pokemon/typings";

const mockedDefaultPokemonSpeciesData: PokemonSpecies = {
  base_happiness: 50,
  capture_rate: 45,
  ...
  genera: [
    ...
    { genus: "씨앗포켓몬", language: { name: "ko", url: "https://pokeapi.co/api/v2/language/3/" } },
    {
      genus: "種子寶可夢",
      language: { name: "zh-Hant", url: "https://pokeapi.co/api/v2/language/4/" },
    },
  ...
  names: [
    ...
    {
      language: { name: "roomaji", url: "https://pokeapi.co/api/v2/language/2/" },
      name: "Fushigidane",
    },
    { language: { name: "ko", url: "https://pokeapi.co/api/v2/language/3/" }, name: "이상해씨" },
    {
      language: { name: "zh-Hant", url: "https://pokeapi.co/api/v2/language/4/" },
      name: "妙蛙種子",
    },
    { language: { name: "fr", url: "https://pokeapi.co/api/v2/language/5/" }, name: "Bulbizarre" },
    { language: { name: "de", url: "https://pokeapi.co/api/v2/language/6/" }, name: "Bisasam" },
    { language: { name: "es", url: "https://pokeapi.co/api/v2/language/7/" }, name: "Bulbasaur" },
    { language: { name: "it", url: "https://pokeapi.co/api/v2/language/8/" }, name: "Bulbasaur" },
    { language: { name: "en", url: "https://pokeapi.co/api/v2/language/9/" }, name: "Bulbasaur" },
    { language: { name: "ja", url: "https://pokeapi.co/api/v2/language/11/" }, name: "フシギダネ" },
    {
      language: { name: "zh-Hans", url: "https://pokeapi.co/api/v2/language/12/" },
      name: "妙蛙种子",
    },
  ...
  pal_park_encounters: [
    {
      area: { name: "field", url: "https://pokeapi.co/api/v2/pal-park-area/2/" },
      base_score: 50,
      rate: 30,
    },
  ],
  pokedex_numbers: [
    { entry_number: 1, pokedex: { name: "national", url: "https://pokeapi.co/api/v2/pokedex/1/" } },
    { entry_number: 1, pokedex: { name: "kanto", url: "https://pokeapi.co/api/v2/pokedex/2/" } },
    {
      entry_number: 226,
    ...
    {
      entry_number: 231,
      pokedex: { name: "updated-johto", url: "https://pokeapi.co/api/v2/pokedex/7/" },
    },
    {
      entry_number: 80,
      pokedex: { name: "kalos-central", url: "https://pokeapi.co/api/v2/pokedex/12/" },
    },
    {
      entry_number: 1,
      pokedex: { name: "letsgo-kanto", url: "https://pokeapi.co/api/v2/pokedex/26/" },
    },
    {
      entry_number: 68,
      pokedex: { name: "isle-of-armor", url: "https://pokeapi.co/api/v2/pokedex/28/" },
    },
  ],
...
const defaultPokemonSpeciesHandler = () => {
  return rest.get(`https://pokeapi.co/api/v2/pokemon-species/:pokemonIdOrName`, (req, res, ctx) => {
    return res(ctx.json(mockedDefaultPokemonSpeciesData));
  });
};

export const mockedDefaultPokemonSpecies = {
  data: mockedDefaultPokemonSpeciesData,
  handler: defaultPokemonSpeciesHandler,
};
