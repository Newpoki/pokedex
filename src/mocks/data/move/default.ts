...
const mockedDefaultMoveData: Move = {
  accuracy: 100,
  contest_combos: {
    normal: {
      use_after: null,
  ...
  name: "pound",
  names: [
    { language: { name: "ja-Hrkt", url: "https://pokeapi.co/api/v2/language/1/" }, name: "はたく" },
    { language: { name: "ko", url: "https://pokeapi.co/api/v2/language/3/" }, name: "막치기" },
    { language: { name: "zh-Hant", url: "https://pokeapi.co/api/v2/language/4/" }, name: "拍擊" },
    { language: { name: "fr", url: "https://pokeapi.co/api/v2/language/5/" }, name: "Écras’Face" },
    { language: { name: "de", url: "https://pokeapi.co/api/v2/language/6/" }, name: "Klaps" },
    { language: { name: "es", url: "https://pokeapi.co/api/v2/language/7/" }, name: "Destructor" },
    { language: { name: "it", url: "https://pokeapi.co/api/v2/language/8/" }, name: "Botta" },
    { language: { name: "en", url: "https://pokeapi.co/api/v2/language/9/" }, name: "Pound" },
    { language: { name: "ja", url: "https://pokeapi.co/api/v2/language/11/" }, name: "はたく" },
    { language: { name: "zh-Hans", url: "https://pokeapi.co/api/v2/language/12/" }, name: "拍击" },
  ],
  past_values: [],
  power: 40,
  pp: 35,
...
const defaultMoveHandler = () => {
  return rest.get("https://pokeapi.co/api/v2/move/pound", (req, res, ctx) => {
    return res(ctx.json(mockedDefaultMoveData));
  });
};

export const mockedDefaultMove = {
  data: mockedDefaultMoveData,
  handler: defaultMoveHandler,
};
