...
const mockedMonsterEggGroupData: EggGroup = {
  id: 1,
  name: "monster",
  names: [
    {
    ...
    { language: { name: "ko", url: "https://pokeapi.co/api/v2/language/3/" }, name: "괴수" },
    { language: { name: "fr", url: "https://pokeapi.co/api/v2/language/5/" }, name: "Monstrueux" },
    { language: { name: "de", url: "https://pokeapi.co/api/v2/language/6/" }, name: "Monster" },
    { language: { name: "es", url: "https://pokeapi.co/api/v2/language/7/" }, name: "Monstruo" },
    { language: { name: "it", url: "https://pokeapi.co/api/v2/language/8/" }, name: "Mostro" },
    { language: { name: "en", url: "https://pokeapi.co/api/v2/language/9/" }, name: "Monster" },
  ],
  pokemon_species: [
...
const monsterEggGroupHandler = () => {
  return rest.get("https://pokeapi.co/api/v2/egg-group/monster", (req, res, ctx) => {
    return res(ctx.json(mockedMonsterEggGroupData));
  });
};

export const mockedMonsterEggGroup = {
  data: mockedMonsterEggGroupData,
  handler: monsterEggGroupHandler,
};
