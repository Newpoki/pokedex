...
const mockedGroundEggGroupData: EggGroup = {
  id: 5,
  name: "ground",
  names: [
    {
    ...
    { language: { name: "ko", url: "https://pokeapi.co/api/v2/language/3/" }, name: "육상" },
    { language: { name: "fr", url: "https://pokeapi.co/api/v2/language/5/" }, name: "Terrestre" },
    { language: { name: "de", url: "https://pokeapi.co/api/v2/language/6/" }, name: "Feld" },
    { language: { name: "es", url: "https://pokeapi.co/api/v2/language/7/" }, name: "Campo" },
    { language: { name: "it", url: "https://pokeapi.co/api/v2/language/8/" }, name: "Campo" },
    { language: { name: "en", url: "https://pokeapi.co/api/v2/language/9/" }, name: "Field" },
  ],
  pokemon_species: [
...
const groundEggGroupHandler = () => {
  return rest.get("https://pokeapi.co/api/v2/egg-group/ground", (req, res, ctx) => {
    return res(ctx.json(mockedGroundEggGroupData));
  });
};

export const mockedGroundEggGroup = {
  data: mockedGroundEggGroupData,
  handler: groundEggGroupHandler,
};
