...
const mockedDragonEggGroupData: EggGroup = {
  id: 14,
  name: "dragon",
  names: [
    {
    ...
    { language: { name: "fr", url: "https://pokeapi.co/api/v2/language/5/" }, name: "Draconique" },
...
const dragonEggGroupHandler = () => {
  return rest.get("https://pokeapi.co/api/v2/egg-group/dragon", (req, res, ctx) => {
    return res(ctx.json(mockedDragonEggGroupData));
  });
};

export const mockedDragonEggGroup = {
  data: mockedDragonEggGroupData,
  handler: dragonEggGroupHandler,
};
