...
const mockedWater1EggGroupData: EggGroup = {
  id: 2,
  name: "water1",
  names: [
    {
    ...
    { language: { name: "ko", url: "https://pokeapi.co/api/v2/language/3/" }, name: "수중 1" },
    { language: { name: "fr", url: "https://pokeapi.co/api/v2/language/5/" }, name: "Aquatique 1" },
    { language: { name: "de", url: "https://pokeapi.co/api/v2/language/6/" }, name: "Wasser 1" },
    { language: { name: "es", url: "https://pokeapi.co/api/v2/language/7/" }, name: "Agua 1" },
    { language: { name: "it", url: "https://pokeapi.co/api/v2/language/8/" }, name: "Acqua 1" },
    { language: { name: "en", url: "https://pokeapi.co/api/v2/language/9/" }, name: "Water 1" },
  ],
  pokemon_species: [
...
const water1EggGroupHandler = () => {
  return rest.get("https://pokeapi.co/api/v2/egg-group/water1", (req, res, ctx) => {
    return res(ctx.json(mockedWater1EggGroupData));
  });
};

export const mockedWater1EggGroup = {
  data: mockedWater1EggGroupData,
  handler: water1EggGroupHandler,
};
